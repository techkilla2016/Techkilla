                    ...
                    <div className="mainContainer">
                        <div className="microHome1">
                            <div className="pagebg">
                                <Image src='/assets/microsite/micrositeHome.png' alt='QR code registration & Auto verification' width={1920} height={1080} />
                            </div>
                        ...
                        <div className="microSection">
                            ...
                            <Container>
                                <div className="microFulImg">
                                    <Image src='/assets/microsite/microsite.png' alt='What is QR Code Registration?' width={1920} height={1080} />
                                </div>
                            ...
                            <Container>
                                <div className="micro_heading01" style={{ textAlign: 'left' }}>Package <span>includes</span></div>
                                {
                                    packageCart?.map((item, index) => {
                                        return <div className="pointBox" key={index}>
                                            <div className="count">
                                                {index + 1}
                                            </div>
                                            <div className="point">
                                            ...
                                            <div className="cost-cart-box">
                                                <div className="cost_cart">
                                                    ...
                                                    <div className="pay_section">
                                                        <div className="cart-btnBox">
                                                            <Link href="http://wa.me/917827362702?text=Hello Techkilla team! %0A%0A I've been looking for a reliable QR-based registration system and I came across your company. I would like to purchase the Basic package - could you help me with the process and any additional details I need to know?" className="price-label">
                                                                ORDER NOW
                                                            </Link>
                                                        </div>
                                                    </div>
                                        ...
                                        <Col xxl={4} xl={4} lg={4} md={6} sm={12}>
                                            <div className="cost-cart-box">
                                                <div className="cost_cart">
                                                    ...
                                                    <div className="pay_section">
                                                        <div className="cart-btnBox">
                                                            <Link href={`http://wa.me/917827362702?text=Hello Techkilla team! %0A%0A I've been looking for a reliable QR-based registration system and I came across your company. I would like to purchase the Standard package - could you help me with the process and any additional details I need to know?`} className="price-label">
                                                                ORDER NOW
                                                            </Link>
                                                        </div>
                                                    </div>
                                        ...
                                        <Col xxl={4} xl={4} lg={4} md={6} sm={12}>
                                            <div className="cost-cart-box">
                                                <div className="cost_cart">
                                                    ...
                                                    <div className="pay_section">
                                                        <div className="cart-btnBox">
                                                            <Link href={`http://wa.me/917827362702?text=Hello Techkilla team! %0A%0A I've been looking for a reliable QR-based registration system and I came across your company. I would like to purchase the Premium Package - could you help me with the process and any additional details I need to know?`} className="price-label">
                                                                ORDER NOW
                                                            </Link>
                                                        </div>
                                                    </div>
                        ...
                        <div className="microSection" style={{ background: '#fff' }}>
                            ...
                            <Container>
                                <div className="microFulImg">
                                    <Image src='/assets/microsite/microsite_02.png' alt='Additional features' width={1920} height={1080} />
                                </div>
                                <div className="microPara">
