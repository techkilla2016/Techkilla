...
export const metadata = {
  title: "Techkilla Innovative Solutions for Events and Experiences",
  description:
    "Learn about Techkilla, a leader in experiential tech solutions. Empowering brands through digital creativity with innovative, interactive event experiences.",
  keywords:
    "Experiential Tech Solutions, Interactive Event Experiences, Brand Empowerment, Digital Creativity, Innovative Marketing Tools, Event Engagement Technologies, Creative Event Strategies, Techkilla Expertise",
};
const About = () => {
  return (
    <>
        ...
        <div className="main">
          <div className="mainContainer">
                ...
                <Row>
                  ...
                  <Col lg={6} md={12} sm={12}>
                    <div className="right-col">
                      ...
                      <p
                        className="section_Para pt-5 text-justify"
                        data-aos="fade-up"
                        data-aos-delay={600}
                      >
                        We are a dynamic team of professionals with a passion
                        for delivering exceptional customer engagement
                        solutions. We work closely with clients to create
                        tailored solutions that address their unique challenges
                        and help them achieve their business goals.
                      </p>
                      <p
                        className="section_Para pb-4"
                        data-aos="fade-up"
                        data-aos-delay={800}
                      >
                        Our team is made up of experts from various backgrounds,
                        including marketing, technology, and design. We are
                        passionate about creating immersive experiences that
                        captivate audiences and enhance customer engagement.
                      </p>
                    </div>
                  </Col>
                </Row>
            ...
            <div className="Expertise_container pt-5">
              <Container>
                <div
                  className="micro_heading01 pt-5"
                  data-aos="zoom-in"
                  data-aos-delay={100}
                >
                      ...
                      return (
                        ...
                        >
                          <div className="graph_container">
                            ...
                            <h4 data-aos="fade-up" data-aos-delay={index * 100}>
                              {item.title}
                            </h4>
                            <p data-aos="fade-up" data-aos-delay={index * 150}>
                              {item.desc}
                            </p>
                          </div>
                        </Col>
                      ...
                      <Row className="align-items-center" key={index}>
                        ...
                        >
                          <div className="choose_list">
                            <h3 data-aos="fade-up" data-aos-delay={index * 100}>
