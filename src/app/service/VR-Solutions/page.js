...
export const metadata = {
  ...
  alternates: {
    canonical: "/service/VR-Solutions",
    languages: {
      "en-US": `/service/VR-Solutions/en-US`,
      "de-DE": `/service/VR-Solutions/de-DE`,
    },
  },
  title: "VR Solutions for Immersive Experiences and Events  - Techkilla",
  description:
    "Techkilla offers VR solutions and AI booths for events. Create engaging, interactive experiences with immersive technology to make your event unforgettable.",
  keywords:
        ...
        <div className="main">
          <div className="mainContainer">
            <div className="product_landing" style={{ background: "#f4f4f4" }}>
              <div className="product_landing_background">
                <div className="preloaderBack">
                  <Image
                    src="/assets/banner/VR-2.png"
                    alt="Physical Engagement"
                    width={1920}
                    height={1080}
                  />
                  <Image
                    src="/assets/banner/VR-1.png"
                    alt="Physical Engagement"
                    width={1920}
                    height={1080}
                  />
                    ...
                    <Row>
                      <Col xxl={8} xl={8} lg={8} md={8} sm={12} xm={12}>
                        <div className="product_main">
                          <h2>VR solutions for limitless possibilities</h2>
                          <p>
                            Step into a world beyond reality with our immersive
                            VR solutions for limitless possibilities. Our
                            cutting-edge technology creates a virtual
                            environment that transports users to new realms,
                            from the depths of the ocean to the vast expanse of
                            outer space.
                          </p>
                        </div>
                      </Col>
            ...
            <div className="desc" style={{ background: "#f4f4f4" }}>
              <h1 className="text-center pb-5">VR Solutions</h1>
              <Container>
                <Row className="justify-content-center">
                  <Col xxl={6} xl={6} md={6} sm={12}>
                    <div className="serviceContainer">
                      ...
                      <p>
                        The term "virtual reality" refers to the practise of
                        using computer technology to construct simulated
                        realities. When using VR, one is immersed in a simulated
                        environment that gives the impression of being in three
                        dimensions. Users no longer look at a screen but rather
                        are immersed in and may interact with 3D environments.
                      </p>
                      <h4>How does it work?</h4>
                      <p>
                        Virtual reality (VR) uses a combination of technology
                        and software to produce experiences that are so
                        realistic they "trick" the viewer's eyes and brain. To
                        create a convincing virtual world, software is
                        responsible for the visuals and audio, while hardware
                        handles the sensory stimulation and simulation.
                      </p>
                    </div>
                  </Col>
                  <Col xxl={6} xl={6} md={6} sm={12}>
                ...
                <Container>
                  ...
                  <Row className="justify-content-center">
                    <Col
                      ...
                      md={10}
                      sm={12}
                      className="use_case_intro "
                    >
                      Industries and divisions that are getting the most
                      benefits of using virtual reality as tool
                    </Col>
                  </Row>
                  <Row>
                    {useCases?.map((item, keys) => (
                      <UseCase key={keys} img={item?.img} title={item?.title} />
                    ))}
                  </Row>
                </Container>
              </div>
