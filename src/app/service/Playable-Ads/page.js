...
export const metadata = {
  ...
  alternates: {
    canonical: "/service/Playable-Ads",
    languages: {
      "en-US": `/service/Playable-Ads/en-US`,
      "de-DE": `/service/Playable-Ads/de-DE`,
    },
  },
  title: "Interactive Playable Ads Services – Engage Your Audience",
  description:
    "Techkilla’s playable ads create interactive digital experiences that engage users. Boost brand interaction with creative ad formats that drive meaningful connections.",
  keywords:
    "Interactive Playable Ads, Experiential Marketing, VR Solutions, On-Ground Marketing, Innovative Campaigns, Marketing Activations, Techkilla Services, Immersive Marketing Strategies, Creative Brand Engagement , Experiential Marketing Services, Techkilla Solutions, VR Marketing Solutions, On-Ground Activations, Innovative Marketing Campaigns",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: siteUrl,
        ...
        <div className="main">
          <div className="mainContainer">
            <div className="product_landing" style={{ background: "#fff" }}>
              <div className="product_landing_background">
                <div className="preloaderBack">
                  <Image
                    src="/assets/banner/Playable-ads_01.png"
                    alt="Physical Engagement"
                    width={1920}
                    height={1080}
                  />
                  <Image
                    src="/assets/banner/Playable-ads.png"
                    alt="Physical Engagement"
                    width={1920}
                    height={1080}
                  />
                    ...
                    <Row>
                      <Col xxl={8} xl={8} lg={8} md={8} sm={12} xm={12}>
                        <div className="product_main">
                          <h1>Interactive Playable-Ads today!</h1>
                          <p>
                            Step into the game and experience the fun with our
                            interactive Playable-Ads today! Our Playable-Ads
                            allow users to engage with your brand in a fun and
                            memorable way.
                          </p>
                        </div>
                      </Col>
            ...
            <div className="pb-5 pt-4 ads_main_play">
              <h2 className="text-center ads_heading">
                What can you do with <br /> <span>Playable Ads?</span>
              </h2>
                  ...
                  {PlayableAdsData?.map((item, keys) => {
                    return (
                      <Col
                        ...
                        sm={12}
                        md={12}
                        className="card-inner-padding d-flex justify-content-center"
                      >
                        <div className="d-100  ads_container_one">
                          <div className="ads-card-back-container">
                            <Image
                              src={item?.bg}
                              alt="techkilla, playable-ads"
                              width={1920}
                              height={1080}
                            />
                          </div>
                          ...
                          <div className="ads_card_front_container">
                            ...
                            <div className="para_container_aside">
                              <div className="side_image">{item?.icon}</div>
              ...
              <h2 className="text-center pt-5 ads_heading mt-5">
                Playable Ads are made up of <br /> <span>three parts</span>{" "}
              </h2>
              <Container>
                <Row>
              ...
              <Container className="py-5">
                <Row>
                  ...
                  >
                    <div className="ads-col-inner">
                      <h3 className="ads_Benefits_heading">
                        {" "}
                        Benefits for <span>consumers</span>
                      </h3>
                      <p className="ads_Benefits_para">
                        Playable is an effective ad unit for mobile <br />
                  ...
                  <Col xxl={5} xl={5} lg={5} md={12} sm={12} xs={12}>
                    <div className="ads-col-inner p-2">
                      <Image
                        src="/assets/service/ads-play.svg"
                        alt="techkilla, Benefits for consumers"
                        width={1920}
                        height={1080}
                      />
                    </div>
