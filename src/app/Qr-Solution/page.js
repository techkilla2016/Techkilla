...
const App = () => {
    ...
    const send = async (contact) => {
        try {
            ...
            router.push('/Qr-Solution/thanks');
            return false
        } catch (error) {
            return false;
        }
                ...
                <div className='row align-items-center py-1 px-3 qr-header'>
                    <Col xxl={2} xl={2} lg={2} md={2} sm={2} xs={2}>
                        <div className="qr-logo">
                            <Image src="/logo/logo-01.png" alt='Techkilla' width={70} height={70} />
                        </div>
                    </Col>
                    ...
                    <div className="contact container-fluid">
                        <div className="row">
                            <div className="col-lg-6 px-0">
                                <div className="hero">
                                    <Image src="/assets/QR/hero.png" alt="techkilla" width={1920} height={1080} />
                                </div>
                            </div>
