...
export default function Gamification() {
  const content = [
    {
      dt: "How do Techkilla’s gamification solutions drive audience participation?",
      dd: "We create interactive experiences like quizzes, puzzle games, and AR-based challenges to engage attendees and keep them involved.",
    },
    {
      dt: "Can these experiences be customized for different brands?",
      dd: "Yes! Our solutions are fully customizable to match your brand theme and marketing goals.",
    },
  ];

  return (
    <>
      <FaqContainer content={content} title={"Gamification"} />
    </>
  );
}
