...
export default function GeneralQuery() {
  const content = [
    {
      dt: "What event technology solutions does Techkilla offer?",
      dd: "We provide AR, VR, AI, and gamification solutions for experiential marketing, crowd engagement, brand promotions, and content creation.",
    },
  ];

  return (
    <>
      <FaqContainer content={content} title={"General Query"} />
    </>
  );
}
