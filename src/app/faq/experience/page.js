...
export default function Experience() {
  const content = [
    {
      dt: "How can AR and VR be used in event marketing?",
      dd: "We create immersive experiences like virtual product demos, AR photo booths, and VR brand storytelling to enhance audience engagement.",
    },
    {
      dt: "Do attendees need special devices to experience AR/VR at the event?",
      dd: " No! We provide user-friendly setups that work with smartphones, tablets, or event screens.",
    },
  ];

  return (
    <>
      <FaqContainer content={content} title={"Experience"} />
    </>
  );
}
