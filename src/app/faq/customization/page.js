...
export default function Customization() {
  const content = [
    {
      dt: "Can Techkilla’s solutions integrate with our event app or CRM?",
      dd: " Absolutely! We can connect data capture tools with your existing systems for seamless insights.",
    },
    {
      dt: " Can we customize branding elements in AI-generated videos and photos?",
      dd: " Yes! Logos, overlays, and brand messages can be integrated in real-time.",
    },
  ];

  return (
    <>
      <FaqContainer content={content} title={"Customization"} />
    </>
  );
}
