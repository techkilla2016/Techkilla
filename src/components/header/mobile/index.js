            ...
            <nav>
                <div className="navbar">
                    <Link href='/' className="logo">
                        <Image priority src='/logo/logo-01.png' alt='techkilla' width={60} height={60} />
                    </Link>
                </div>
                    ...
                    <div className={isMobile ? "active mobile-container" : "mobile-container "} id='hideMobileNave'>
                        <div className={isMobile ? "mobile-nav active" : "mobile-nav"}>
                            <div className='mobileMenuContaienr'>
                                ...
                                <div className='listMenu' onClick={() => childHandal([
                                    {
                                        title: 'Single Photo AI',
                                        url: '/ai-solution/single-photo-ai'
                                    },
                                    {
                                        title: 'Group Photo AI',
                                        url: '/ai-solution/group-photo-ai'
                                    },
                                    {
                                        title: 'Video AI',
                                        url: '/ai-solution/video-ai'
                                    }
                                ])}>
                                    AI Solution
                                </div>
                    ...
                    <div className='Mobile_nav_child_modal_inner'>
                        {
                            curChild?.map((item, key) => {
                                return <div key={key} className='listMenu' onClick={() => {
                                    // setIsMobile(false)
                                    // setIsChild(false)
                                }}>
