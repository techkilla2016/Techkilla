            ...
            <Row>
              ...
              <Col xxl={8} lg={8} md={8} xs={12}>
                <div className="d-flex flex-column align-items-center justify-content-center h-100">
                  <h2 className="demoText">Schedule Free Demo</h2>
                  <Button
          ...
          <div className="padding_4x">
            <div className="flex">
              <section className="flex-content padding_1x">
                <h3>Top Products</h3>
                <Link href="/QR-code-solution">QR Registration</Link>
                <Link href="https://www.instagram.com/p/CjPoSz7DaSw">
                  {" "}
                  360° Spin Booth
                </Link>
                <Link href="/case-studies/Excitometer-Tetra-Pak">
            ...
            <div className="flex">
              <section className="flex-content padding_1x">
                <p>
                  Copyright © {new Date().getFullYear()} Techkilla Technologies
                  Pvt. Ltd
                </p>
              </section>
              <section className="flex-content padding_1x">
                ...
                <Link
                  href="https://twitter.com/techkilla15?s=08"
                  target={"_blank"}
                >
                  <AiOutlineTwitter />
                </Link>
                <Link
                  href="https://www.instagram.com/techkillatechnologies/?igshid=1j33p32nqf62k"
                  target={"_blank"}
                >
                  <BsInstagram />
                </Link>
                <Link
                  href="https://www.linkedin.com/company/techkilla"
                  target="_blank"
                >
                  <GrLinkedinOption />
                </Link>
