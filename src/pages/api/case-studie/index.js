...
const case_studie = [
    ...
    {
        id: 2,
        slag: 'https://www.instagram.com/p/CjPoSz7DaSw/',
        Heading: 'Spin Booth',
        cart_them: '/use-case/Spin-booth.png',
    ...
    {
        id: 3,
        slag: '/case-studies/Excitometer-Tetra-Pak',
        Heading: 'Tetra Pak',
        cart_them: '/use-case/Tetra-Pak.png',
    ...
    {
        id: 4,
        slag: 'https://www.youtube.com/shorts/gt75HKHKMxk',
        Heading: 'HDFC AnalytIQ 3.0',
        cart_them: '/use-case/HDFC.png',
    ...
    {
        id: 5,
        slag: 'https://www.instagram.com/p/CmddNv-oDak/',
        Heading: 'Bounce header',
        cart_them: '/use-case/Bounceheader.png',
    ...
    },
    {
        ...
        slag: '/case-studies/',
        Heading: 'CEAT Tyres',
        cart_them: '/use-case/CEAT-Tyres.png',
        desc: "The ITC Foods brand Sunfeast is already well-known in the market and has now introduced its own Instagram filter, where users of social media would participate and try to play 6 balls in a header round."
    },

    {
        ...
        cart_them: '/use-case/ConcentrixGotTalent.png',
...

    {
        ...
        cart_them: '/use-case/HDFCInquizitive.png',
    ...
    },
    {
        ...
        Heading: 'TVS Motors',
        cart_them: '/use-case/TVSMotors.png',
    ...
    },
    {
        ...
        cart_them: '/use-case/CricketGame.png',
    ...
    {
        id: 11,
        slag: 'https://www.instagram.com/p/Cdaf6nIAuEf/',
        Heading: 'KUKU FM',
        cart_them: '/use-case/KUKUFM.png',
    ...
    {
        id: 12,
        slag: 'https://www.instagram.com/p/Ckh8VKyDVuc/',
        Heading: 'Bounce Football Roll',
        cart_them: '/use-case/Football.png',
    ...
    },
    {
        ...
        cart_them: '/use-case/Carlsberg.png',
        desc: "360 Photobooth or Spinbooth - Carlsberg Beer"
    },
    {
        id: 14,
        slag: '/case-studies/Microsoft-Hackathon',
        Heading: 'Microsoft Hackathon',
        cart_them: '/use-case/Hackathon.png',
